...
<div class="col-sm-5">
      ...
      <div class="card-body">
        ...
        {{-- <div class="row">
          ...
          <form action="/Adherent/rate/search" method="GET">
        ...
        <div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                <td><img src="/uploads/avatars/{{ $user->avatar}}" style="width:35px;heith:32px; border-radius:50%">
                 </td>
                   <td>{{ $user->name }}&nbsp;{{ $user->lastname }}</td>
                        ...
                        <td>
                    <form action="/Adherent/rate/{{ $user->id }}" method="POST">
                        {{ csrf_field() }}
                        {{method_field('PUT')}}
          ...
          <br>
          <a href="/indexadherent" class="btn btn-secondary" >Back To home</a>
        </div>
